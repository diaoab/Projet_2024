...
<body>
    ...
    <h1>Exercice3: Tirage; utilisation de "for"</h1>
    <?php
        $nombre_initial = rand(100, 999);
        $nombre_tent = 0;
        echo "<p>Le nombre a trouver est : $nombre_initial</p>";
        for ($nombre_tirer = rand(100, 999); $nombre_tirer !== $nombre_initial; $nombre_tirer = rand(100, 999)) {
            $nombre_tent++;
            echo "<p>Tirage $nombre_tent : $nombre_tirer</p>";
        }
        echo "<p>Le nombre de tirages effectues avant de trouver le nombre $nombre_initial est de : $nombre_tent</p>";
    ?>
</body>
</html>