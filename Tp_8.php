...
<body>
    ...
    <h1>Exercice9: Tableau multidimentionnel associatif </h1>
    <?php
    $personnes = array(
        'DIENE' => array(
            'prenom' => 'Ali',
    ...
    echo "Le prénom de Ali est : " . $personnes['DIENE']['prenom'] . "<br>";
    echo "La ville de Oumou est : " . $personnes['DIONE']['ville'] . "<br>";
    echo "Le sexe de Sara est : " . $personnes['VASQUEZ']['sexe'] . "<br>";
    echo "L'âge de Musa est de : " . $personnes['JUNIOR']['age'] . " ans<br>";
    ?>
</body>
</html>
