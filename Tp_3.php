...
<head>
    ...
    <title>Exercice4: Calcul du PPCM</title>
    <style>
        body {
...
<body>
    ...
    <form method="post" action="">
        <label for="nombre1">Veuillez renseigner la valeur du premier nombre :</label>
        <input type="text" name="nombre1" id="nombre1">
        <br>
        <label for="nombre2">Veuillez renseigner la valeur du second nombre :</label>
